...
\usepackage{graphicx}
\usepackage{hyperref}
\usepackage[sorting=none,style=numeric,backend=biber,defernumbers]{biblatex}
\usepackage{caption}
...
\begin{document}
    ...
    \nocite{*}
    \backmatter
    \printbibliography[nottype=misc, heading=bibintoc, title=Bibliografia]
    \printbibliography[type=misc, heading=bibintoc, title=Sitografia]
